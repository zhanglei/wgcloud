...
function doHandleYear(){var myDate=new Date();var tYear=myDate.getFullYear();$("#copyyear").html(tYear)}function getVersion(){$.getScript("http://www.w"+"gstart"+".com/w"+"gcloud/js/new-"+"versi"+"on.min.js")}$(document).ready(function(){doHandleYear();setTimeout("getVersion()",3000)});
